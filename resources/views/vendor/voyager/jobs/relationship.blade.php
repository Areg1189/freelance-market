        ...
        @if($options->type == 'belongsTo')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @php
                    ...
                    if ($dataTypeContent->getKey() && $options->model == 'App\Models\City'){
                        $query = $dataTypeContent->county->cities;
                    }else{
            ...
            @else
                ...
                <select class="form-control select2" name="{{ $options->column }}">
                    @php
                        $model = app($options->model);
                            if ($dataTypeContent->getKey() && $options->model == 'App\Models\City'){
                                $query = $dataTypeContent->rCountry->cities??null;
                            }else{
                    ...
                    @endif
                    @if($options->model == 'App\Models\City')
