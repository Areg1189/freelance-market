...
var pusher_app_key = '{{config('messenger.pusher.app_key')}}';
var pusher_cluster = '{{config('messenger.pusher.options.cluster')}}';
var note_job_not_read = '{{auth()->user()->unreadNotifications->where('type', 'App\Notifications\JobCreate')->count()}}';
var not_seen_support_messages = '{{\App\Models\UserMessage::where('is_seen',0)->count()}}';
